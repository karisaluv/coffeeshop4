                        ...
                        <div class="p-5">
                            ...
                            <form action="routers/r_login.php?aksi=register" method="POST"
                             class="user">
                                ...
                                <!-- untuk menampung inputan id dari user -->
                                <div class="form-group">
                                        <input type="text" class="form-control form-control-user" 
                                            placeholder="id" name="id" hidden>
                                    </div>
                                    
                                <!-- untuk menampung inputan nama dari user -->
                                <div class="form-group">
                                ...
                                <!-- untuk menampung inputan email dari user -->
                                <div class="form-group">
                                        <input type="email" class="form-control form-control-user" id="exampleInputEmail"
                                            placeholder="Email Address" name="email">
                                    </div>
                                     <!-- untuk menampung inputan password dari user -->
                                <div class="form-group">
                                     <input type="password" class="form-control form-control-user" id="password"
                                            placeholder="password" name="password">
                                    </div>
                                    <!-- untuk menampung inputan role dari user -->
                                <div class="form-group">
